...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        launch(args);
//        Uncomment the line below to execute no GUI tests
//        runNoGUITests();
    }

    private static void runNoGUITests() {
        int squareSizeCm = 30;
...
//         SOUTH tests
    ...
    public static void generateCar(Settings settings, Junction junction) {
        ...
        if ((settings.getTraffic() == 0 && car_generated_rand <= 0.33) || (settings.getTraffic() == 1 && car_generated_rand <= 0.22) || (settings.getTraffic() == 2 && car_generated_rand <= 0.11)) {
            ...
            // NORTH junction.placeVehicle(new Vehicle(roadLengthCm/squareSizeCm + 1, 0, Direction.NORTH, Direction.SOUTH, Type.CAR, 2));
